              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: tokens.typography.label.copyWith(color: tokens.colors.primary),
                  ),
                ],
              ),
            ),
        ...
        LayrzRow(
          ...
          children: [
            LayrzCol(
              ...
              md: 4,
              lg: 3,
              child: _ColumnBox(label: '12/6/4/3', tokens: tokens, color: tokens.colors.primary),
            ),
            LayrzCol(
              xs: 12,
              sm: 6,
              md: 4,
              lg: 3,
              child: _ColumnBox(label: '12/6/4/3', tokens: tokens, color: tokens.colors.success),
            ),
            LayrzCol(
              xs: 12,
              sm: 6,
              md: 4,
              lg: 3,
              child: _ColumnBox(label: '12/6/4/3', tokens: tokens, color: tokens.colors.warning),
            ),
            LayrzCol(
              xs: 12,
              sm: 6,
              md: 4,
              lg: 3,
              child: _ColumnBox(label: '12/6/4/3', tokens: tokens, color: tokens.colors.danger),
            ),
          ],
        ),
      ],
      ...
      children: [
        ...
        LayrzRow(
          ...
          children: [
            LayrzCol(
              xs: 6,
              child: _ColumnBox(label: 'span: 6', tokens: tokens, color: tokens.colors.primary.darken(0.12)),
            ),
            LayrzCol(
              xs: 5,
              child: _ColumnBox(label: 'span: 5', tokens: tokens, color: tokens.colors.primary),
            ),
            LayrzCol(
              xs: 4,
              child: _ColumnBox(label: 'span: 4', tokens: tokens, color: tokens.colors.primary.lighten(0.12)),
            ),
            LayrzCol(
              xs: 4,
              child: _ColumnBox(label: 'span: 4', tokens: tokens, color: tokens.colors.primary.lighten(0.12)),
      ...
      children: [
        ...
        Container(
          ...
          child: LayrzConstrainedView(
            ...
            spacing: tokens.spacing.sp3,
            children: [
              _ColumnBox(label: 'Child 1', tokens: tokens, color: tokens.colors.primary),
              _ColumnBox(label: 'Child 2', tokens: tokens, color: tokens.colors.success),
              _ColumnBox(label: 'Child 3', tokens: tokens, color: tokens.colors.warning),
            ],
          ),
        ),
      ],
