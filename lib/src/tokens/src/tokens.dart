...
/// are seeded consistently: [LayrzShadowTokens] is seeded with [LayrzColorTokens.sf2]
...
class LayrzTokens {
  ...
  /// - [LayrzShadowTokens] is seeded with the resulting [colors.sf2] and [radius.r2]
