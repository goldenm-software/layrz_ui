...
class _LayrzMonthInputState extends State<LayrzMonthInput> {
  ...
  /// Opens [LayrzMonthSurface] via [LayrzResponsiveModal.show] — see
  ...
  /// Save permanently disabled for the rest of that open, even though
  /// [widget.value] was already non-null, since nothing else ever re-primes
  /// it. Computing the seed from [widget.value] directly (mirroring
